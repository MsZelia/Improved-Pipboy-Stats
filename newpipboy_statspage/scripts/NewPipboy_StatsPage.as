package
{
   ...
   public class NewPipboy_StatsPage extends IPipBoyPage
   {
      ...
      public var _PerksTab:CustomPerksTab;
      ...
      public function NewPipboy_StatsPage()
      {
         super();
         m_EventPrefix = "STATS::";
         this._PerksTab = new CustomPerksTab();
         addChild(this._PerksTab);
         ImprovedPipboyStatsConfig.init(this);
         this.PerksTab_mc.SetVisibility(false);
      }
      ...
      override public function SetPlatform(auiPlatform:uint, abPS3Switch:Boolean, auiController:uint, auiKeyboard:uint) : void
      {
         ...
         this._PerksTab.SetPlatform(auiPlatform,abPS3Switch,auiController,auiKeyboard);
