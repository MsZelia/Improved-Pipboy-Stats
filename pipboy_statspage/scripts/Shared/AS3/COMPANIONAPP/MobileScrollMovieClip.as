package Shared.AS3.COMPANIONAPP
{
   ...
   public class MobileScrollMovieClip
   {
      ...
      private function mouseMoveHandler(param1:MouseEvent) : void
      {
         ...
         if(this._mouseDown)
         {
            if(!isNaN(param1.stageX) && !isNaN(param1.stageY))
            {
               ...
               {
                  this._scrollMovieClip.y += _loc3_ * this.RESISTANCE_OUT_BOUNDS;
               }
               else
               {
                  this._scrollMovieClip.y += _loc3_;
               }
      ...
      {
         var _loc3_:Number = NaN;
         var _loc2_:Number = this._mouseDown ? this.VELOCITY_MOUSE_DOWN_FACTOR : this.VELOCITY_MOUSE_UP_FACTOR;
         ...
         if(!this._mouseDown)
         {
            ...
            {
               this._scrollMovieClip.y += this._velocity + _loc3_;
            }
         }
      }
   }
