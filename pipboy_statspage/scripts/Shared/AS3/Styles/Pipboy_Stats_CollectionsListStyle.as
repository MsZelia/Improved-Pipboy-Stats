package Shared.AS3.Styles
{
   ...
   public class Pipboy_Stats_CollectionsListStyle
   {
      
      public static var listEntryClass_Inspectable:String = "CollectionsListEntry";
      ...
      public function Pipboy_Stats_CollectionsListStyle()
      {
         super();
      }
   }
